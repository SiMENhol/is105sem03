...
func TestKrypter(t *testing.T) {
	...
	tests := []test{
		...
		{inputMessage: []rune("Kjevik;SN39040;18.03.2022 01:50;6"), alphabet: ALF_SEM03, chiffer: 4, want: []rune("dnizmocdd7;484c5: 47 6466d45b94c.")},
		{inputMessage: []rune("dnizmocdd7;484c5: 47 6466d45b94c."), alphabet: ALF_SEM03, chiffer: len(ALF_SEM03) - 4, want: []rune("Kjevik;SN39040;18.03.2022 01:50;6")},
	}
